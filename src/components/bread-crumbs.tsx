...
export function Breadcrumbs({
  ...
  return (
    <nav
      ...
      className={cn(
        "flex w-full items-center overflow-auto text-sm font-semibold text-b-muted",
        className
      )}
      {...props}
    >
        ...
        return (
          <React.Fragment key={segment.href}>
            <Link
              ...
              href={segment.href}
              className={cn(
                "truncate transition-colors hover:text-b-accent",
                isLastSegment ? "text-b-accent" : "text-b-muted"
              )}
            >
