...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border border-slate-200 px-2.5 py-0.5 leading-[9px] text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 dark:border-slate-800 dark:focus:ring-slate-800",
  {
    variants: {
      variant: {
        default:
